...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: 'Merge PDF Online Free — Combine PDF Files | FileToolBox',
...
const FAQS = [
  { q: 'How many PDF files can I merge at once?', a: 'You can merge up to 20 PDF files at once with FileToolBox. All processing happens in your browser — no file size limits.' },
  ...
  { q: 'Do I need an account to merge PDFs?', a: 'No account or registration is ever required. All tools on FileToolBox are 100% free with no sign-up.' },
]
